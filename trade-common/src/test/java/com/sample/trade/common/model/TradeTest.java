...
class TradeTest {
    ...
    void testEqualsAndHashCode() {
        ...
        Trade trade1 = new Trade("T3", 1, "CP-3", "B3", maturityDate, createdDate, "N");
        Trade trade2 = new Trade("T3", 1, "CP-3", "B3", maturityDate, createdDate, "N");
        Trade trade3 = new Trade("T4", 1, "CP-3", "B3", maturityDate, createdDate, "N");
    ...
    void testEqualsWithNull() {
        Trade trade = new Trade("T5", 1, "CP-5", "B5", LocalDate.now(), LocalDate.now(), "N");
    ...
    void testEqualsWithSelf() {
        Trade trade = new Trade("T6", 1, "CP-6", "B6", LocalDate.now(), LocalDate.now(), "N");
